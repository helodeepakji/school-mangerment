                                ...
                                @foreach ($classes as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="#edit_role" data-bs-toggle="modal" data-bs-target="#edit_role" onclick="getClass({{$item->id}})">
                                                <i class="ri-pencil-fill cursor-pointer"></i> </a>

                                            <a href="#delete_modal" data-bs-toggle="modal" data-bs-target="#delete_modal" onclick="getDeleteClass({{$item->id}})">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body text-center">
                ...
                <p class="mb-3">You want to delete this class, this cant be undone once you delete.
                </p>
                <div class="d-flex justify-content-center">
                    <a href="javascript:void(0);" class="btn btn-light me-3" data-bs-dismiss="modal">Cancel</a>
                    <a onclick="getDelete()" id="btn-class-id" class="btn btn-danger">Yes, Delete</a>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    function getDeleteClass(id){
        $('#btn-class-id').data('role-id',id);
    }
    ...
    function getDelete(){
        var id = $('#btn-class-id').data('role-id');
