...
<script>
    ...
    $('#school_id').change(() => {
        ...
        $.ajax({
            url: '/api/getRoleBySchool/' + id,
            type: 'GET',
            dataType: 'json',
            success: function (response) {
                $('#role_id').html('<option value="">Select Role</option>');
                response.forEach(element => {
                    $('#role_id').append(`<option value="${element.id}">${element.role_name}</option>`);
                });
            }
        });
    });
    ...
    function getUser(id) {
        $.ajax({
            ...
            success: function (response) {
                ...
                $.ajax({
                    url: '/api/getRoleBySchool/' + response.school_id,
                    type: 'GET',
                    dataType: 'json',
                    success: function (response) {
                        $('#edit_role_id').html('<option value="">Select Role</option>');
                        response.forEach(element => {
                            $('#edit_role_id').append(`<option value="${element.id}">${element.role_name}</option>`);
                        });
